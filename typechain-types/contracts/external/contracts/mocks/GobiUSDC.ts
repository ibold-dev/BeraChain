...
export interface GobiUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_CALL"
...
export interface GobiUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): GobiUSDC;
  waitForDeployment(): Promise<this>;

  interface: GobiUSDCInterface;
