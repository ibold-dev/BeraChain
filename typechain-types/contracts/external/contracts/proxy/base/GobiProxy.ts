...
export interface GobiProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowInitializePath"
      | "deposit"
...
export interface GobiProxy extends BaseContract {
  connect(runner?: ContractRunner | null): GobiProxy;
  waitForDeployment(): Promise<this>;

  interface: GobiProxyInterface;
