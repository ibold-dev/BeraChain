...
export interface IGobiProxyInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowInitializePath"
      | "deposit"
...
export interface IGobiProxy extends BaseContract {
  connect(runner?: ContractRunner | null): IGobiProxy;
  waitForDeployment(): Promise<this>;

  interface: IGobiProxyInterface;
  ...
  deposit: TypedContractMethod<
    [_dstEid: BigNumberish, _amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  quoteDeposit: TypedContractMethod<
    [_dstEid: BigNumberish, _sender: AddressLike, _value: BigNumberish],
    [MessagingFeeStructOutput],
    "view"
  >;
  ...
  redeem: TypedContractMethod<[_dstEid: BigNumberish], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[_dstEid: BigNumberish], [void], "nonpayable">;
  getFunction(
