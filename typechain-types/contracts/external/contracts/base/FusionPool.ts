...
export interface FusionPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowInitializePath"
      | "endpoint"
...
export interface FusionPool extends BaseContract {
  connect(runner?: ContractRunner | null): FusionPool;
  waitForDeployment(): Promise<this>;

  interface: FusionPoolInterface;
