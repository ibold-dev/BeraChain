...
export interface IGobiPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowInitializePath"
      | "endpoint"
...
export interface IGobiPool extends BaseContract {
  connect(runner?: ContractRunner | null): IGobiPool;
  waitForDeployment(): Promise<this>;

  interface: IGobiPoolInterface;
