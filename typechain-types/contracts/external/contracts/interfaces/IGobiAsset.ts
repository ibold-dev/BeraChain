...
export interface IGobiAssetInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "SEND"
      | "SEND_AND_COMPOSE"
...
export interface IGobiAsset extends BaseContract {
  connect(runner?: ContractRunner | null): IGobiAsset;
  waitForDeployment(): Promise<this>;

  interface: IGobiAssetInterface;
